            ...
            case when Q90 <= 8.5 then
              case when Q90 <= 7.5 then
                case when Q85 <= 0.0 then
                   return 0.10771992818671454 # (60.0 out of 557.0)
                else  # if Q85 > 0.0
        ...
        case when Q85 <= 3.5 then
          ...
          case when Q83 <= 5.5 then
            ...
            case when Q96 <= 10.0 then
               ...
               return 0.2 # (1.0 out of 5.0)
            end           end         end       else  # if Q89 > 5.5
        case when Q90 <= 4.0 then
          case when Q90 <= 2.0 then
             return 0.6666666666666666 # (2.0 out of 3.0)
          else  # if Q90 > 2.0
             return 1.0 # (4.0 out of 4.0)
          end         else  # if Q90 > 4.0
              ...
              case when Q94 <= 8.5 then
                ...
                case when Q85 <= 8.5 then
                  ...
                  case when Q1 <= 4.0 then
                     ...
                     return 0.6666666666666666 # (2.0 out of 3.0)
                  end                 end               end             end           else  # if Q84 > 10.5
            case when Q96 <= 10.0 then
               return 0.3333333333333333 # (1.0 out of 3.0)
            else  # if Q96 > 10.0
               return 0.0 # (0.0 out of 4.0)
